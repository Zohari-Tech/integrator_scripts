const main = (payload, constants) => {
  ...
  if (main_response.responseParam.statusCode === "113") {
    finalstatus = "TRX204";
  }
...
// Partner code 415
// "username": "Musren_API", \
// "password": "Admin%40123Musren%401234" \
// 'https://dtsvc.safaricom.com:8480/api/public/SDP/activate'
// 'https://dtsvc.safaricom.com:8480/api/auth/login'
// 'https://dtsvc.safaricom.com:8480/api/public/SDP/deactivate'
